...
export default function Header() {
    return (
      ...
      {/* <div className="mx-auto w-full sm:px-6 sm:py-32 "> */}
        <div className="relative isolate h-[740px] overflow-hidden bg-gray-100 px-6 pt-16 shadow-2xl  sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          {/* <svg
